...
cleaned_md_grants_loans |>
  ...
  group_by(source, zip_code, amount) |>
  arrange(desc(amount))
```

I think the right answer is Zip code 21601 got the most from the Maryland Tourism Board with 800000. Yes the zip code makes sense to me.
