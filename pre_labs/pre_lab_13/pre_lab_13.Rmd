...
**Task** Run the following code. Describe the model output. What do you see? **Answer: I see that the p-value is over 0.)5 so I would say that it is not as reliable as if there was more poling done.**
