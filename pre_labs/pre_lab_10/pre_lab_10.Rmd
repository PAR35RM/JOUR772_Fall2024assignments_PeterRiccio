...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** The column names are OBJECTID, ZIPCODE2, ZIPNAME, EXISTING, ZIPCODE1, Shape_Leng, Shape_Area, and geometry.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It contains zip code areas as well as their ids and geographical space
...
**Task** Run the following code. Describe the output in the space below. It installed new packages but was not really sure where to go to find what the changes were.
...
**Task** Run the following code. Describe the output in the space below. **Answer** it generated another dataframe
...
library(janitor)
library(tidycensus)
census_api_key("75635ee0236adf9450d51b4c51d5a0b739fd2b6a", install = TRUE, overwrite = TRUE)
```
...
**Task** Run the following code. Describe the output in the space below. **Answer** it was able to input a chart for MD with a color gradient.
...
**Task** Run the following code. Describe the output in the space below. **Answer** same table but more distinguishable
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** it looks like the further south you go the higher the range is
