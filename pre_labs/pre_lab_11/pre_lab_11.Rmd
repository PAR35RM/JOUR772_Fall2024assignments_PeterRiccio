...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: I don't think there is anything incorrect about the code but to me what seems counter intuitive is why would you go through the process of getting the information and joining the two tables if at the end you are still viewing the two tables separately.**
