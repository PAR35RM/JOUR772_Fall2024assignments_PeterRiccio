...
I got 220 for the first part. It says 223 rows but I only counted 220. The the second part I got Geographical Sciences.
...
```{r}
courses_2023 <- umd_courses |> filter(term > 202300) |> filter(syllabus_count >= 1)
...
Not sure I coded this right as the answer I got is the American Studies department for part 1, and Journalism did not even show up on the table for the second part.
...
As time goes on he is gradually spending more and more.
...
```{r}
umd_courses |>
  filter(str_detect(title, "Sports")) |> filter(str_detect(id, "JOUR"))
```

I would want to learn how many Journalism classes involve sports or sports writing.

**A5**

There are 80 Journalism classes involving sports or sports writing.
