...
I tried to do the last map but I ran into a problem I cannot figure out how to fix. It keeps saying "**Caused by error in \`compute_layer()\`:**
! \`stat_sf()\` requires the following missing aesthetics: geometry." I tried asking chatGPT but what it gave me didn't really make any sense either
...
ev_population <- md_county_population |> inner_join(ev_counties, by = c('GEOID'))
